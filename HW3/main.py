...
from bokeh.models import (
    ColumnDataSource, Slider, NumeralTickFormatter, CDSView, GroupFilter, 
...
def get_data(t1, t2, t3, t4, clusters):
    ...
    region_df = df.loc[lambda df: df.Region == int(t4), :]
...
p2 = figure(x_range=p1.x_range, y_range=p1.y_range, tools=DEFALUT_TOOLS, **PLOT_PARAM)
